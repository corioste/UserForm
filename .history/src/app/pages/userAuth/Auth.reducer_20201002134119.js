...
function login(state = initialState, action = null) {
    switch (action.type) {
        ...
        case REQUEST_CHANGE_PASSWORD:
            console.log(REQUEST_CHANGE_PASSWORD)
            return {
                ...state,
                loading: true,
                errorMessage: ""
        ...
        case REQUEST_CHANGE_PASSWORD_SUCCESS:
            console.log(REQUEST_CHANGE_PASSWORD_SUCCESS)
            return {
                ...state,
                loading: false,
                errorMessage: ""
        ...
        case REQUEST_CHANGE_PASSWORD_FAILED:
            console.log(REQUEST_CHANGE_PASSWORD_FAILED)
            return {
                ...state,
                loading: false,
                errorMessage: "Old Password Didnt Match"
            }
