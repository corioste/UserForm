...
class Login extends Component {
    ...
    resetPassword = () => {
        ...
        this.props.forgotPassword({email: this.state.forgetEmail})
    }   
        ...
        return (
            this.props.isLoggedIn ? <Redirect to={"/"} /> :
                <div>
                    ...
                    >
                         <Input prefix={<UserOutlined className="site-form-item-icon" />} onChange={this.forgetInput} placeholder="Email" />
