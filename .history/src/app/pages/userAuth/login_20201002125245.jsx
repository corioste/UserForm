...
import { login, register, loggedUser, forgotPassword } from "./Auth.action";
...
class Login extends Component {
    ...
    forgetInput = (event) =>{
        this.setState({
            forgetEmail: event.target.value
        })
    }
    ...
    resetPassword = () => {
        ...
        this.props.forgotPassword(this.state.forgetEmail)
    }   
        ...
        return (
            this.props.isLoggedIn ? <Redirect to={"/"} /> :
                <div>
                        ...
                        <Spin spinning={this.props.isLoading}>
                            ...
                            >
                                ...
                                <Form.Item>
                                    ...
                                    <Button onClick={() => { this.setState({ forgotVisible: true }) }}>Forgot Password</Button>
                                </Form.Item>
                                ...
                                <Form.Item>
                                    ...
                                    <div style={{ height: '20px', color: 'red', textAlign: 'center' }}>{this.props.errormessage}</div>
                    ...
                    >
                         <Input type="email" prefix={<UserOutlined className="site-form-item-icon" />} onChange={this.forgetInput} placeholder="Email" />
