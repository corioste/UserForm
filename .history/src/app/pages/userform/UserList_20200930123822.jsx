...
const UserList = ({deletUser, selectUser,selectedUser, getUser, userList,resetSelectUser}) => {
    ...
    const columns = [
        ...
        },
        {
          ...
          render: (text,record) => (
            <div>
              <Button onClick={()=>{updateUserClick(record.id,record.fullName,record.email,record.dateOfBirth,record.gender)}} type="primary">Update</Button>
    ...
    const updateUserClick = (id,name,email,dateOfBirth,gender) =>{
        console.log(name)
