...
const UserList = ({selectedUser, getUser , deletUser , selectUser, resetSelectUser , userList}) => {
...
export default connect(mapStateToProps,mapDispatchToProps,selectUser)(UserList);
