...
const mapDispatchToProps = (dispatch) => {
    return {userList: dispatch(getUser) }
}


export default connect(mapStateToProps, mapDispatchToProps{ getUser,deletUser,selectUser , resetSelectUser , resetSelectUser })(UserList);
