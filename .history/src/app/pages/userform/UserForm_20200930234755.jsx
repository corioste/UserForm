...
const UserForm = ({ formState }) => {
    ...
    const handleSubmit = (values) => {
        let formatted_date = values.birthdate._d.getFullYear() + "-" + (values.birthdate._d.getMonth() + 1) + "-" + values.birthdate._d.getDate()
    ...
    useEffect(() => {
        ...
        if (formState.UserReducer.selectedUser.length !== 0) {
            ...
            form.setFieldsValue({
                ...
                birthdate: new Date(formState.UserReducer.selectedUser.dateOfBirth),
