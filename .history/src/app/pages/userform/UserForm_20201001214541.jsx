...
import {
    Row, Col, Typography, Input, Form, Button, Radio, DatePicker, Image
} from 'antd';
...
const UserForm = ({ formState, createUser,updateUser }) => {
    ...
    const handleSubmit = (values) => {
        ...
        var selectedUser = formState.UserReducer.selectedUser.length

        var id = selectedUser == 0 ? 
            new Date().getUTCMilliseconds().toString():
            formState.UserReducer.selectedUser.id,
    ...
    useEffect(() => {
        ...
        if (selectedUser !== 0) {
            ...
            setImageUrl(formState.UserReducer.selectedUser.imageURL)
            form.setFieldsValue({
                firstname: .firstName,
...
const mapStateToProps = (state) => {
    return { formState: state.UserReducer.selectedUser }
}

const mapStateDispatchToProps = dispatch => {
    return {
        createUser: (data) => dispatch(createUser(data))
        , updateUser: (data) => dispatch(updateUser(data)), selectUser
    }
}
